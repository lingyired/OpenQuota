...
export const fr = {
  app: {
    usageDashboard: 'Usage01 usage dashboard',
    reorderInstructions:
      'Drag to reorder. With a keyboard, use Alt plus Up Arrow or Alt plus Down Arrow.',
    resizePanelHeight: 'Resize panel height',
    windowControls: 'Usage01 window controls',
    hideUsage01: 'Hide Usage01',
    closeUsage01: 'Close Usage01',
    back: 'Back',
    ...
    errors: {
      providerRefresh: 'Usage01 could not start a provider refresh.',
      ...
      panelResize: 'Usage01 panel resize could not be started.',
      windowMove: 'Usage01 window could not be moved.',
      panelHeightMode: 'Usage01 could not change the panel height mode.',
      ...
      backendUnavailable: 'Usage01 backend is unavailable.',
      eventBridge: 'Usage01 event bridge is unavailable.',
    },
  },
  dashboard: {
    all: 'Tous',
    ...
    updateReady: 'Usage01 {version} is ready to download.',
    whatsNew: 'What’s new',
  ...
  settings: {
    ...
    openFromAnywhere: 'Open Usage01 from anywhere',
    ...
    notificationsBlockedDesc: 'Enable Usage01 notifications in system settings.',
    ...
    temporarilyUnavailable: 'Usage01 settings are temporarily unavailable.',
    changedBeforeSaved: 'Settings changed before they could be saved. Please try again.',
    accountCouldNotLoad: 'Usage01 account settings could not be loaded.',
    accountNamesUnavailable: 'Usage01 account names are temporarily unavailable.',
    accountNamesCouldNotSave: 'Usage01 account names could not be saved.',
    couldNotSave: 'Usage01 settings could not be saved.',
  ...
  providerError: {
    ...
    cacheUnavailable: 'Usage01 cache is unavailable.',
    dataDirUncreatable: 'Usage01 data directory could not be created',
    databaseUnavailable: 'Usage01 database is unavailable',
    databaseLockUnavailable: 'Usage01 database lock is unavailable',
    cachedDataInvalid: 'Cached Usage01 data is invalid',
  ...
  update: {
    ...
    downloadPageError: 'The Usage01 download page could not be opened.',
    tryAgainLater: 'Try again later.',
    tryAgainOrDownload: 'Try again or download the installer from the release page.',
    upToDate: 'Usage01 {version} is up to date.',
    available: 'Usage01 {version} is available.',
    availableNoVersion: 'An Usage01 update is available.',
    ...
    alreadyUpToDate: 'Usage01 is already up to date.',
    ...
    networkFailed: 'Usage01 could not complete that action because the network request failed.',
    networkFailedAction: 'Check your connection or proxy, then try again.',
    genericFailed: 'Usage01 could not complete that action.',
