...
export const fr = {
  app: {
    usageDashboard: 'OpenQuota01 usage dashboard',
    reorderInstructions:
      'Drag to reorder. With a keyboard, use Alt plus Up Arrow or Alt plus Down Arrow.',
    resizePanelHeight: 'Resize panel height',
    windowControls: 'OpenQuota01 window controls',
    hideOpenQuota01: 'Hide OpenQuota01',
    closeOpenQuota01: 'Close OpenQuota01',
    back: 'Back',
    ...
    errors: {
      providerRefresh: 'OpenQuota01 could not start a provider refresh.',
      ...
      panelResize: 'OpenQuota01 panel resize could not be started.',
      windowMove: 'OpenQuota01 window could not be moved.',
      panelHeightMode: 'OpenQuota01 could not change the panel height mode.',
      ...
      backendUnavailable: 'OpenQuota01 backend is unavailable.',
      eventBridge: 'OpenQuota01 event bridge is unavailable.',
    },
  },
  dashboard: {
    all: 'Tous',
    ...
    dismiss: 'Dismiss',
    welcome: 'Welcome to OpenQuota01',
    welcomeBody:
  ...
  settings: {
    ...
    openFromAnywhere: 'Open OpenQuota01 from anywhere',
    ...
    notificationsBlockedDesc: 'Enable OpenQuota01 notifications in system settings.',
    ...
    temporarilyUnavailable: 'OpenQuota01 settings are temporarily unavailable.',
    changedBeforeSaved: 'Settings changed before they could be saved. Please try again.',
    accountCouldNotLoad: 'OpenQuota01 account settings could not be loaded.',
    accountNamesUnavailable: 'OpenQuota01 account names are temporarily unavailable.',
    accountNamesCouldNotSave: 'OpenQuota01 account names could not be saved.',
    couldNotSave: 'OpenQuota01 settings could not be saved.',
  ...
  providerError: {
    ...
    cacheUnavailable: 'OpenQuota01 cache is unavailable.',
    dataDirUncreatable: 'OpenQuota01 data directory could not be created',
    databaseUnavailable: 'OpenQuota01 database is unavailable',
    databaseLockUnavailable: 'OpenQuota01 database lock is unavailable',
    cachedDataInvalid: 'Cached OpenQuota01 data is invalid',
  ...
  update: {
    ...
    downloadPageError: 'The OpenQuota01 download page could not be opened.',
    tryAgainLater: 'Try again later.',
    tryAgainOrDownload: 'Try again or download the installer from the release page.',
    upToDate: 'OpenQuota01 {version} is up to date.',
    available: 'OpenQuota01 {version} is available.',
    availableNoVersion: 'An OpenQuota01 update is available.',
    ...
    alreadyUpToDate: 'OpenQuota01 is already up to date.',
    ...
    networkFailed: 'OpenQuota01 could not complete that action because the network request failed.',
    networkFailedAction: 'Check your connection or proxy, then try again.',
    genericFailed: 'OpenQuota01 could not complete that action.',
