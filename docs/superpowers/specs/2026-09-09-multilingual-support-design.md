...
Usage01 当前仅支持 English 和简体中文。前端使用 `svelte-i18n`，英文词典是类型结构的源，简体中文词典与其保持同构；Rust 侧则单独为托盘菜单、系统通知和 Windows 任务栏维护少量文案。用户希望依据 OpenCode 的公开本地化信号，扩展到更适合 AI 编程工具用户的语言范围。
