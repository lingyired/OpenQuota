...
Add an OpenRouter API key from **Customize** in Quota01. Saved keys are kept in the encrypted
credential vault protected by the operating system credential store. Quota01 can also use
