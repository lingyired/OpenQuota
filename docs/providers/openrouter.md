...
Add an OpenRouter API key from **Customize** in Usage01. Saved keys are kept in the encrypted
credential vault protected by the operating system credential store. Usage01 can also use `OPENROUTER_API_KEY` or
