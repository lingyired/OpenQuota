...
Usage01 tracks the shared Gemini and Claude quota pools reported by Antigravity.
...
Sign in through Antigravity or run `agy`. Usage01 reuses Antigravity's locally stored credentials
and can also discover a compatible running Antigravity language server. No API key needs to be added
to Usage01.

## Troubleshooting

- **Not signed in** — open Antigravity or run `agy`, complete sign-in, then refresh Usage01.
