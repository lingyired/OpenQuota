<p align="center">
  <img src="assets/quota01-icon.png" alt="Quota01 logo" width="88">
</p>

<h1 align="center">Quota01</h1>
...
Quota01 checks for updates automatically. Update payloads are cryptographically signed with the
...
Windows SmartScreen or macOS Gatekeeper may therefore ask for confirmation. Download Quota01 only
...
MiniMax require API keys, which you can add in Customize; Quota01 stores them securely in your
...
Quota01 is based on the OpenQuota project and was also inspired by [OpenUsage](https://github.com/robinebers/openusage) and developed as a
