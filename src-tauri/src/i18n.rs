...
pub fn tr(locale: Locale, key: &'static str) -> &'static str {
    match (locale, key) {
        (Locale::En, "menu.open") => "Open OpenQuota01",
        (Locale::ZhCn, "menu.open") => "打开 OpenQuota01",
        (Locale::ZhTw, "menu.open") => "打開 OpenQuota01",
        (Locale::Es, "menu.open") => "Abrir OpenQuota01",
        (Locale::PtBr, "menu.open") => "Abrir OpenQuota01",
        (Locale::Ja, "menu.open") => "OpenQuota01 を開く",
        (Locale::Ko, "menu.open") => "OpenQuota01 열기",
        (Locale::De, "menu.open") => "OpenQuota01 öffnen",
        (Locale::Fr, "menu.open") => "Ouvrir OpenQuota01",
        (Locale::Ru, "menu.open") => "Открыть OpenQuota01",
        (Locale::Hi, "menu.open") => "OpenQuota01 खोलें",
        (Locale::Ar, "menu.open") => "فتح OpenQuota01",
        (Locale::It, "menu.open") => "Apri OpenQuota01",
        (Locale::Pl, "menu.open") => "Otwórz OpenQuota01",
        (Locale::Tr, "menu.open") => "OpenQuota01'yu aç",
        (Locale::Vi, "menu.open") => "Mở OpenQuota01",
        ...
        (Locale::En, "menu.quit") => "Quit OpenQuota01",
        (Locale::ZhCn, "menu.quit") => "退出 OpenQuota01",
        (Locale::ZhTw, "menu.quit") => "結束 OpenQuota01",
        (Locale::Es, "menu.quit") => "Salir de OpenQuota01",
        (Locale::PtBr, "menu.quit") => "Sair do OpenQuota01",
        (Locale::Ja, "menu.quit") => "OpenQuota01 を終了",
        (Locale::Ko, "menu.quit") => "OpenQuota01 종료",
        (Locale::De, "menu.quit") => "OpenQuota01 beenden",
        (Locale::Fr, "menu.quit") => "Quitter OpenQuota01",
        (Locale::Ru, "menu.quit") => "Выйти из OpenQuota01",
        (Locale::Hi, "menu.quit") => "OpenQuota01 छोड़ें",
        (Locale::Ar, "menu.quit") => "إنهاء OpenQuota01",
        (Locale::It, "menu.quit") => "Esci da OpenQuota01",
        (Locale::Pl, "menu.quit") => "Zamknij OpenQuota01",
        (Locale::Tr, "menu.quit") => "OpenQuota01'dan çık",
        (Locale::Vi, "menu.quit") => "Thoát OpenQuota01",

        (Locale::En, "notif.open") => "Open OpenQuota01",
        (Locale::ZhCn, "notif.open") => "打开 OpenQuota01",
        (Locale::ZhTw, "notif.open") => "打開 OpenQuota01",
        (Locale::Es, "notif.open") => "Abrir OpenQuota01",
        (Locale::PtBr, "notif.open") => "Abrir OpenQuota01",
        (Locale::Ja, "notif.open") => "OpenQuota01 を開く",
        (Locale::Ko, "notif.open") => "OpenQuota01 열기",
        (Locale::De, "notif.open") => "OpenQuota01 öffnen",
        (Locale::Fr, "notif.open") => "Ouvrir OpenQuota01",
        (Locale::Ru, "notif.open") => "Открыть OpenQuota01",
        (Locale::Hi, "notif.open") => "OpenQuota01 खोलें",
        (Locale::Ar, "notif.open") => "فتح OpenQuota01",
        (Locale::It, "notif.open") => "Apri OpenQuota01",
        (Locale::Pl, "notif.open") => "Otwórz OpenQuota01",
        (Locale::Tr, "notif.open") => "OpenQuota01'yu aç",
        (Locale::Vi, "notif.open") => "Mở OpenQuota01",
