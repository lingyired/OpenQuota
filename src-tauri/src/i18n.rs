...
pub fn tr(locale: Locale, key: &'static str) -> &'static str {
    match (locale, key) {
        (Locale::En, "menu.open") => "Open Quota01",
        (Locale::ZhCn, "menu.open") => "打开 Quota01",
        (Locale::ZhTw, "menu.open") => "打開 Quota01",
        (Locale::Es, "menu.open") => "Abrir Quota01",
        (Locale::PtBr, "menu.open") => "Abrir Quota01",
        (Locale::Ja, "menu.open") => "Quota01 を開く",
        (Locale::Ko, "menu.open") => "Quota01 열기",
        (Locale::De, "menu.open") => "Quota01 öffnen",
        (Locale::Fr, "menu.open") => "Ouvrir Quota01",
        (Locale::Ru, "menu.open") => "Открыть Quota01",
        (Locale::Hi, "menu.open") => "Quota01 खोलें",
        (Locale::Ar, "menu.open") => "فتح Quota01",
        (Locale::It, "menu.open") => "Apri Quota01",
        (Locale::Pl, "menu.open") => "Otwórz Quota01",
        (Locale::Tr, "menu.open") => "Quota01'yu aç",
        (Locale::Vi, "menu.open") => "Mở Quota01",
        ...
        (Locale::En, "menu.quit") => "Quit Quota01",
        (Locale::ZhCn, "menu.quit") => "退出 Quota01",
        (Locale::ZhTw, "menu.quit") => "結束 Quota01",
        (Locale::Es, "menu.quit") => "Salir de Quota01",
        (Locale::PtBr, "menu.quit") => "Sair do Quota01",
        (Locale::Ja, "menu.quit") => "Quota01 を終了",
        (Locale::Ko, "menu.quit") => "Quota01 종료",
        (Locale::De, "menu.quit") => "Quota01 beenden",
        (Locale::Fr, "menu.quit") => "Quitter Quota01",
        (Locale::Ru, "menu.quit") => "Выйти из Quota01",
        (Locale::Hi, "menu.quit") => "Quota01 छोड़ें",
        (Locale::Ar, "menu.quit") => "إنهاء Quota01",
        (Locale::It, "menu.quit") => "Esci da Quota01",
        (Locale::Pl, "menu.quit") => "Zamknij Quota01",
        (Locale::Tr, "menu.quit") => "Quota01'dan çık",
        (Locale::Vi, "menu.quit") => "Thoát Quota01",

        (Locale::En, "notif.open") => "Open Quota01",
        (Locale::ZhCn, "notif.open") => "打开 Quota01",
        (Locale::ZhTw, "notif.open") => "打開 Quota01",
        (Locale::Es, "notif.open") => "Abrir Quota01",
        (Locale::PtBr, "notif.open") => "Abrir Quota01",
        (Locale::Ja, "notif.open") => "Quota01 を開く",
        (Locale::Ko, "notif.open") => "Quota01 열기",
        (Locale::De, "notif.open") => "Quota01 öffnen",
        (Locale::Fr, "notif.open") => "Ouvrir Quota01",
        (Locale::Ru, "notif.open") => "Открыть Quota01",
        (Locale::Hi, "notif.open") => "Quota01 खोलें",
        (Locale::Ar, "notif.open") => "فتح Quota01",
        (Locale::It, "notif.open") => "Apri Quota01",
        (Locale::Pl, "notif.open") => "Otwórz Quota01",
        (Locale::Tr, "notif.open") => "Quota01'yu aç",
        (Locale::Vi, "notif.open") => "Mở Quota01",
