...
pub fn tr(locale: Locale, key: &'static str) -> &'static str {
    match (locale, key) {
        (Locale::En, "menu.open") => "Open Usage01",
        (Locale::ZhCn, "menu.open") => "打开 Usage01",
        (Locale::ZhTw, "menu.open") => "打開 Usage01",
        (Locale::Es, "menu.open") => "Abrir Usage01",
        (Locale::PtBr, "menu.open") => "Abrir Usage01",
        (Locale::Ja, "menu.open") => "Usage01 を開く",
        (Locale::Ko, "menu.open") => "Usage01 열기",
        (Locale::De, "menu.open") => "Usage01 öffnen",
        (Locale::Fr, "menu.open") => "Ouvrir Usage01",
        (Locale::Ru, "menu.open") => "Открыть Usage01",
        (Locale::Hi, "menu.open") => "Usage01 खोलें",
        (Locale::Ar, "menu.open") => "فتح Usage01",
        (Locale::It, "menu.open") => "Apri Usage01",
        (Locale::Pl, "menu.open") => "Otwórz Usage01",
        (Locale::Tr, "menu.open") => "Usage01'yu aç",
        (Locale::Vi, "menu.open") => "Mở Usage01",
        ...
        (Locale::En, "menu.quit") => "Quit Usage01",
        (Locale::ZhCn, "menu.quit") => "退出 Usage01",
        (Locale::ZhTw, "menu.quit") => "結束 Usage01",
        (Locale::Es, "menu.quit") => "Salir de Usage01",
        (Locale::PtBr, "menu.quit") => "Sair do Usage01",
        (Locale::Ja, "menu.quit") => "Usage01 を終了",
        (Locale::Ko, "menu.quit") => "Usage01 종료",
        (Locale::De, "menu.quit") => "Usage01 beenden",
        (Locale::Fr, "menu.quit") => "Quitter Usage01",
        (Locale::Ru, "menu.quit") => "Выйти из Usage01",
        (Locale::Hi, "menu.quit") => "Usage01 छोड़ें",
        (Locale::Ar, "menu.quit") => "إنهاء Usage01",
        (Locale::It, "menu.quit") => "Esci da Usage01",
        (Locale::Pl, "menu.quit") => "Zamknij Usage01",
        (Locale::Tr, "menu.quit") => "Usage01'dan çık",
        (Locale::Vi, "menu.quit") => "Thoát Usage01",

        (Locale::En, "notif.open") => "Open Usage01",
        (Locale::ZhCn, "notif.open") => "打开 Usage01",
        (Locale::ZhTw, "notif.open") => "打開 Usage01",
        (Locale::Es, "notif.open") => "Abrir Usage01",
        (Locale::PtBr, "notif.open") => "Abrir Usage01",
        (Locale::Ja, "notif.open") => "Usage01 を開く",
        (Locale::Ko, "notif.open") => "Usage01 열기",
        (Locale::De, "notif.open") => "Usage01 öffnen",
        (Locale::Fr, "notif.open") => "Ouvrir Usage01",
        (Locale::Ru, "notif.open") => "Открыть Usage01",
        (Locale::Hi, "notif.open") => "Usage01 खोलें",
        (Locale::Ar, "notif.open") => "فتح Usage01",
        (Locale::It, "notif.open") => "Apri Usage01",
        (Locale::Pl, "notif.open") => "Otwórz Usage01",
        (Locale::Tr, "notif.open") => "Usage01'yu aç",
        (Locale::Vi, "notif.open") => "Mở Usage01",
